...
<h1>Control de administracion</h1>
    ...
    echo "</tr>";
      ...
      echo "<a href='https://iawdanielvaldes-com.stackstaging.com/registropagina.php'>Añadir usuario</a>";
      echo "<a href='https://iawdanielvaldes-com.stackstaging.com/usuarios.php'>Gestion usuarios</a>";
    } else {
      echo "0 results";
    }
        mysqli_close($enlace);
